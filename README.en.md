...
- Affected Artifacts rule: use full paths or links (e.g., `02_REQUIREMENTS/capabilities/REQ-*.md`, `02_REQUIREMENTS/competencies/CQ-*.md`)
...
- Actions:
  ...
  - CQ is created/updated under `02_REQUIREMENTS/competencies/CQ-*.md` (when needed)
...
Store CQ documents under `02_REQUIREMENTS/competencies/`.
